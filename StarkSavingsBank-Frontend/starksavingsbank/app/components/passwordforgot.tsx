...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(AppConstants.ROOT_URL + "/password-forgot", {
        "email": email
      })
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-100">
            Recover Your Realm Access
          </h2>
          <p className="mt-2 text-center text-sm text-gray-300">
            Fear not, for even the mightiest warriors sometimes forget their keys to the castle.
          </p>
        </div>
          ...
          {!isSubmitted ? (
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  {isSubmitting ? 'Sending Raven...' : 'Send Raven'}
                </button>
              </div>
            </motion.form>
          ) : (
            ...
            >
              <p className="text-lg text-gray-100 mb-4">
                A raven has been dispatched to your keep. Check your messages for further instructions to reclaim your realm access.
              </p>
